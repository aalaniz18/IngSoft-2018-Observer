...
public class Login extends javax.swing.JFrame {
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//OK!
    }
    ...
    private void jTextField2ActionPerformed(java.awt.event.ActionEvent evt) {//OK!
        this.UserR=jTextField2.getText().toLowerCase();
    }

    private void jPasswordField2ActionPerformed(java.awt.event.ActionEvent evt) {//OK!
    	this.PassR=jPasswordField2.getText().toLowerCase();
    }

    private void jPasswordField3ActionPerformed(java.awt.event.ActionEvent evt) {//OK!
