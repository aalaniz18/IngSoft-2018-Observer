...
import model.CargaBox;
import model.Cargador;
import resources.Generador;
...
public class Compra extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            ResultSet Stock = cb.CargarStock();
            int id = c.getIdRs(Stock, jComboBox1.getSelectedItem().toString());
            double precio = c.getPrecio(id);
            int cantidad = Integer.parseInt(jComboBox2.getSelectedItem().toString());

            c.agregaItem("3h2ñ58wn",
                    id,
    ...
    private void setFilas(String codigoCompra) throws SQLException {
        Object datos[] = new Object[5];
        CargaBox c = new CargaBox();
        Cargador car = new Cargador();
        Generador gen = new Generador();
        ResultSet Resultados = car.obtenerCompra(codigoCompra);
    ...
    private void setBoxStock() throws SQLException {
    ...
    private void setBoxCompra() throws SQLException {
        jComboBox3.removeAllItems();
        jComboBox4.removeAllItems();
        Cargador c = new Cargador();
        ResultSet Compra = c.obtenerCompra("3h2ñ58wn");
        while (Compra.next()) {
            jComboBox3.addItem(Compra.getString(2));}
         for (int i = 1; i < 11; i++) {
            jComboBox4.addItem(String.valueOf(i)); }
    }
    private void setTextBoxs() throws SQLException {
        Cargador c = new Cargador();
        CargaBox cb = new CargaBox();
        ResultSet Stock = cb.CargarStock();
        int id = c.getIdRs(Stock, jComboBox1.getSelectedItem().toString());
